...
const Postwrapper = ({ children }) => {
  return (
    <div className="flex justify-center w-full mt-5">
      <div className="mt-6 flex w-full px-[5%] justify-between xl:px-0 xl:w-[75%] max-w-[1300px] items-start gap-x-[10px] lg:flex-row flex-col">
        <div className={`lg:w-[58%] w-full`}>{children}</div>
        <div className={`lg:w-[38%] w-full md:pl-[25px] pl-0`}>
          <div className="flex flex-col gap-y-[25px] lg:mt-0 mt-[35px] stick top-[150px] left-0">
