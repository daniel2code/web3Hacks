  ...
  return (
    ...
    >
      ...
      <div className={`${checkView ? "w-full" : "w-[90%]"}`}>
        ...
        >
          <p className="text-[12px] font-medium text-[#000]">Testnet</p>{" "}
          <div className={`w-[25px] border border-gray-200 border-t-0`} />
          <p className="text-[11px] text-[#000]">December 31, 2023</p>
        </div>
        ...
        <p className={`text-[14px] text-[#000] ${checkView ? "my-4" : "my-0"}`}>
